...
User.prototype.removeSavedPost = function(id){
  this.savedPosts.splice((this.savedPosts.findIndex(obj =>( obj.id === id))), 1)
  return this.savedPosts
}
...
User.prototype.changePostRating = function(id, newRating){
  let indexOfElement = this.savedPosts.findIndex((element) => (element.id === id))
  this.savedPosts[indexOfElement].rating = newRating;
